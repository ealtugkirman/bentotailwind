    ...
    <div className="flex flex-col text-center pb-16 md:pb-0 justify-center rounded-2xl ">
      <div className="space-y-4">
        ...
        <p className="text-gray-300 md:pt-4 text-sm md:text-2xl justify-center px-12 md:px-48 flex md:flex-row flex-col items-center space-y-1">
          ...
          <button
            className="px-4 mx-2  text-xs md:text-lg flex w-24  items-center shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] font-bold justify-center py-2
...
const Card = ({ title, subtitle, Icon, href }) => {
  return (
    <a
      href={href}
      className="w-full py-4 md:py-12 h-36  md:h-52 items-center justify-center p-4 rounded-lg  relative overflow-hidden group bg-firstlight">
      ...
      <h3 className="text-start pt-4 md:pt-8  md:text-lg  font-bold text-gray-300 group-hover:text-black relative z-10 duration-300">
        {title}
      </h3>
