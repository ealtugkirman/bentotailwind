...
const page = () => {
  return (
    <div className="bg-first" >
       <div className="max-w-3xl py-12 text-gray-300  mx-auto">
      <div className="border-b space-y-6 pb-6 border-gray-500">
        <h3 className="text-5xl capitalize font-bold text-yellow-200">
      ...
      <div className="space-y-6">
        <p className="mt-6">
          ...
          and/or services: website themes and templates (the "Marketplace
          Offerings"). In order to help make the Site a secure environment for
          the purchase and sale of Marketplace Offerings, all users are required
          to accept and comply with these Terms of Use. You agree that by
          accessing the Site and/or the Marketplace Offerings, you have read,
        ...
        <p>
          ...
          actual colors and details of the products. All Marketplace Offerings
          are subject to availability, and we cannot guarantee that Marketplace
          Offerings will be in stock. Certain Marketplace Offerings may be
          available exclusively online through the Site. Such Marketplace
          Offerings may have limited quantities and are subject to return or
        ...
        <h2 className="font-bold text-3xl text-yellow-300">SUBMISSIONS</h2>
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">SITE MANAGEMENT</h2>
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">DISCLAIMER</h2>
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">INDEMNIFICATION</h2>{" "}
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">USER DATA</h2>{" "}
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">MISCELLANEOUS</h2>
        <p>
        ...
        <h2 className="font-bold text-3xl text-yellow-300">CONTACT US</h2>
        <p>
          ...
          https://bentotailwind.com/contact/
        </p>
      </div>
      </div>
      <Footer />
