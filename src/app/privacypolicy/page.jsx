...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-2xl text-gray-300 mx-auto px-4 py-8">
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Privacy Policy</h2>
        <p className="mb-4">
          Read about the privacy policy for BentoTailwind. If you have a
          question please{" "}
          <a
            href="https://bentotailwind.com/contact/"
        ...
        <p className="mb-4">
          Thank you for choosing to be part of our community at DigitalVoyage
          ...
          regards to your personal information, please {""}
          <a
            href="https://bentotailwind.com/contact/"
            className="text-blue-500">
            contact us
      ...
      <section className="mb-8">
        <h2 className="text-4xl text-yellow-200 font-semibold mb-4">
          Table of Contents
        </h2>
        <ul className="list-disc text-xl underline underline-offset-4 space-y-3 pl-4">
          <li>
            <a href="#info-collection">What information do we collect?</a>
          </li>
          <li>
            <a href="#info-usage">How do we use your information?</a>
          </li>
          <li>
            <a href="#info-sharing">
          ...
          <li>
            <a href="#info-retention">How long do we keep your information?</a>
          </li>
          <li>
      ...
      <section className="mb-8" id="info-collection">
        <h2 className="text-4xl text-yellow-200 font-semibold mb-4">
        ...
        <p>
          ...
          <br />
          <br />
          <span className="font-bold text-yellow-200">Payment Data.</span> We
          ...
          instrument. All payment data is stored by Paddle. You may find their
          privacy notice link(s) here:{" "}
          <a className="text-blue-500" href="https://paddle.com/privacy/">
        ...
        <p className="pl-4">
          ...
          access or use our Website and which we record in log files. Depending
          ...
          <br />
          Location Data. <br /> We collect location data such as information
      ...
      <section className="mb-8" id="info-sharing">
        <h2 className="text-4xl text-yellow-200 font-semibold mb-4">
      ...
      <section className="mb-8" id="info-retention">
        <h2 className="text-4xl text-yellow-200 font-semibold mb-4">
      ...
      <section className="mb-8" id="do-not-track">
        <h2 className="text-4xl text-yellow-200 font-semibold mb-4">
      ...
      <section className="mb-8" id="updates">
        ...
        https://bentotailwind.com/contact/. We will respond to your request within 30
        days.
      </section>
    </div>
  );
