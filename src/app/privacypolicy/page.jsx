...
const PrivacyPolicy = () => {
  return (
    <div className="bg-first" >
      <div className="max-w-3xl text-gray-300 mx-auto px-4 py-8">
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Inc. (" Company ", "we", "us", "our"). We are committed to
        ...
        <section className="mb-8" id="info-usage">
          ...
          <p>
            ...
            please contact us at https://bentotailwind.com/contact/ and be sure
        ...
        <section className="mb-8" id="updates">
          ...
          visit: https://bentotailwind.com/contact/. We will respond to your
