...
const Title = ({ children }) => (
    <h3 className='pb-3 px-4 font-medium text-yellow-200'>
        { children }
    </h3>
);
...
const Sidebar = () => {
    const lessons = {
        ...
        bentoGrids: [{ name: "Reveal Bento", href: "/components/reveal-bento" }, { name: "Fade In Grid", href: "/components/fadein-bento-grid" }, { name: "Coming Soon...", href: "/components/coming-soon" }]
    }

    return (
        <>
            <nav
                className="fixed hidden md:flex z-10 pb-20 bottom-20 top-32 left-0 w-full h-full border-r bg-first space-y-8 overflow-auto sm:w-64">
