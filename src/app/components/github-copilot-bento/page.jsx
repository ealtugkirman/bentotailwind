...
const CoPilotBento = () => {
  return (
    <div className="grid h-screen  rounded-lg gap-3 grid-cols-5 grid-rows-4">
      <div className="rounded-lg justfiy-center items-center col-span-3 bg-gradient-to-l from-purple-200 to-purple-800  row-span-2">
        <h1 className="text-white font-bold text-2xl">
          Proven to increase developer productiivty and accelerate the pace of
      ...
      <div className="rounded-lg col-span-2 bg-gradient-to-tr from-blue-900 to-slate-900 row-span-2">
        h
      </div>
      <div className="rounded-lg col-span-2 bg-gradient-to-br from-blue-900 to-slate-900 row-span-2">
        h
      </div>
      <div className="rounded-lg col-span-3 bg-gradient-to-r from-purple-200 to-purple-800  row-span-2">
        h
      </div>
    </div>
  );
      ...
      <div className="hidden lg:block lg:3/4 w-4/5 px-24 bg-first">
        ...
        <div className="pt-12 h-96  md:pt-24 mx-12">
          <p>
            ...
            . He is a one of the best developers that i follow. You should
            definitly check his and website{" "}
            <a
              className="underline underline-offset-2"
              href="https://www.youtube.com/@tomisloading">
              {" "}
              youtube channel.
            </a>
          </p>
